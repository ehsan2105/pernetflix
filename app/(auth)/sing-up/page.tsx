    ...
    return (
        <>
            ...
            <form method="post" action='/api/auth/signin' >
                    <h1 className=" text-3xl font-semibold text-white "> پیوستن به ما  </h1>
                    <div className=" space-y-4 mt-5 ">
                        ...
                        <Button className=" w-full " type="submit">نام نویسی</Button>
                    </div>
                </form>
                <div>
                    ...
                    <p className=" text-gray-400 text-sm mt-2 ">
                        اکانت داری
                        ؟
                        <Link className=" text-white hover:underline" href='/login'>وارد شدن </Link>
                    </p>
                </div>
